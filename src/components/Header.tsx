...
export const Header = () => {
	...
	return (
		<header className={`fixed flex w-full items-center justify-between ${!!scrollPosition ? 'h-20 bg-white' : 'h-32 bg-gradient-to-b from-[#00000090] to-transparent backdrop-blur-sm'} transition-all duration-700`}>
			<div className="p-8 flex w-full items-center justify-between">
				...
				<div className="space-x-8">
					...
					<Link expanded={!!scrollPosition} title="HAPPY STORIES" url="/happy-stroies/" />
				</div>
			</div>
		</header>
	)
